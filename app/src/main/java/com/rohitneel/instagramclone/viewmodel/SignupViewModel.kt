...
class SignupViewModel : ViewModel() {
    ...
    private fun validateUserName(userName: String): Boolean {
        ...
        _userNameValidation.postValue(isValid)
        return isValid
    }
    ...
    private fun validatePassword(password: String): Boolean {
     ...
     fun validateData(userName: String, userEmail: String, userPassword: String): Boolean {
        val validateUserName = validateUserName(userName)
        val validateUserEmail = validateEmail(userEmail)
        val validateUserPassword = validatePassword(userPassword)

        return validateUserName && validateUserEmail && validateUserPassword
    }
}